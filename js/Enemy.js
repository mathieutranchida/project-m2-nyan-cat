...
class Enemy {
  ...
  constructor(theRoot, enemySpot) {
    ...
    this.domElement.src = "./images/carEnemy.png";
    ...
    // Set timer to count the time elapsed and increase the speed of enemies
  ...
  update(timeDiff, increase) {
    ...
    this.y = this.y + timeDiff * this.speed * (1 + increase / 8);
    this.domElement.style.top = `${this.y}px`;
